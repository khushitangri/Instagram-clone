...
import { Editing, MessengerIcon, Updown, WronguP } from '../../../Icons';
...
Messages
    ...
    <div>
    <Link to={'/message/request/'}>
  <button className='text-gray-300 font-medium'>
Request
    </button>
  </Link>
    </div>
...
<button className='ml-[380px] text-[20px] font-medium' onClick={FalseUpdown}>
X
</button>
<div>
  <img className='h-20 ml-24 mt-6' src={InstaLogo} alt="" />
</div>
<input className='w-[280px] ml-12 h-8 outline-none mt-6 bg-[#1c1e21]  text-white text-[12px] pl-2' type="text" placeholder='Phone number, username, or email'/>
<input className='w-[280px] ml-12 h-8 outline-none mt-4 bg-[#1c1e21]  text-white text-[12px] pl-2' type="text" placeholder='Password'/> <br /> <br />
<div className='flex items-center gap-2'>
<input className='ml-12' type="checkbox" name="" id="" /> <span className='text-[13px] '> Save login info</span>

</div>
<button className='bg-blue-400 w-[270px] flex justify-center items-center h-8 rounded-[10px] text-[14px] font-bold mt-2 ml-[60px]'>
Log in
</button>
<div className='ml-40 text-[13px] mt-6'>
  Forget password?
</div>
    </div>
   ...
   edit && (
    <div className='bg-[#3A3B3C] mt-[160px] rounded-[10px] ml-4 w-[500px] h-[400px] relative z-20'>
      <div className='flex ml-40 pt-2'>
        ...
        <button className='ml-[160px] text-[20px] font-medium' onClick={FalseEdit}>
X
</button>
      </div>
      <div className='pl-6 font-medium text-[18px] border-t border-b'>
        ...
        To : <input className='bg-[#3A3B3C] outline-none pl-2 text-[14px]' type="text" placeholder='Search....'/>
        </div>
      </div>
      </div>
   ) 
...
<div className='h-[100px] p-6 border-2 w-[110px] ml-[60px] rounded-[50%]'>
<MessengerIcon/>
</div>
<div className='text-[22px] ml-[60px]'>
  Your Messages
</div>
